...
ALTER TABLE cat_estatus_salud MODIFY COLUMN Permite_Entrenar VARCHAR(20);
...
ALTER TABLE medidas_fisicas MODIFY COLUMN ID_Medida INT AUTO_INCREMENT;
...
(35, 35, 2, 5, 5, '150 kg (Híbrido)', '2026-03-05'), -- Inuyasha: Peso Muert
(36, 36, 2, 5, 5, '350 kg (Control de Tierra)', '2026-03-05'), -- Toph Beifong: Peso Muerto
(37, 37, 1, 4, 10, '90 kg (Fuego de Control)', '2026-03-05'),  -- Zuko: Press Militar
(38, 38, 7, 6, 12, '800 kg (Modo Sabio)', '2026-03-06'),       -- Naruto Uzumaki: Sentadilla Búlgara
(39, 39, 3, 5, 15, 'Estilo Puño Suave', '2026-03-06'),         -- Neji Hyuga: Dominadas
(40, 40, 4, 8, 5, 'Chidori Explosivo', '2026-03-06'),          -- Sasuke Uchiha: Sprints
(41, 41, 6, 4, 2, 'Copia de Resistencia', '2026-03-06'),       -- Kakashi Hatake: Plancha (2 min)
(42, 42, 7, 10, 100, 'Puertas Internas Abiertas', '2026-03-06'),-- Rock Lee: Sentadilla Búlgara (¡Sobreentrenando!)
(43, 43, 9, 3, 3, '2,500 kg (Fuerza Monstruosa)', '2026-03-06'),-- Tsunade: Press de Banca
(44, 44, 3, 4, 15, 'Golpe del Dragón', '2026-03-07'),          -- Ranma Saotome: Dominadas
(45, 45, 2, 6, 8, '180 kg (Carga Pesada)', '2026-03-07'),      -- Ryoga Hibiki: Peso Muerto
(46, 46, 6, 3, 1, 'Disciplina Tendo', '2026-03-07');
